...
<div class="share-buttons">
    <ul class="share-buttons">
        ...
        <li><a href="mailto:?subject=&amp;body=<?php echo $url?>" target="_blank" title="Email link" aria-label="Send link to article via email"><img alt="Email" src="<?php echo DIR_SITE?>graphics/icon_email.svg" onclick="window.open('mailto:?subject=' + encodeURIComponent(document.title) + '&body=' +  encodeURIComponent(document.URL)); return false;"></a></li>
    </ul>
</div>
